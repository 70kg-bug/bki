...
# Defined in xgb_math, not here, so scoring.py can reach them without importing a
# training stage. Re-exported by this import: s15, s16 and gate_pivot already do
# `from .s13_calibrate import xgb_predict`, and one definition is the point.
from ..core.xgb_math import _logit, xgb_predict  # noqa: F401

warnings.filterwarnings("ignore", category=UserWarning)

REPORT_JSON = C.RPT_S13_CALIBRATION
BAKEOFF_JSON = C.RPT_S11_BAKEOFF
...
# xgb_predict lives in xgb_math -- see the import block at the top of this file.
